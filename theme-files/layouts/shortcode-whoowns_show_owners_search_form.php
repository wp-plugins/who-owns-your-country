...
<div id="whoowns_search">
	<div id="whoowns_search_options">
		...
		<div id="whoowns_search_input">
			...
			<img src="<?=plugins_url( 'images/search01.png', dirname(dirname(__FILE__)) )?>" id="whoowns_search_button" alt="<?=__('Search', 'whoowns')?>" title="<?=__('Search', 'whoowns')?>" onClick="whoowns_submit_search(this);" />
